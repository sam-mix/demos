...
type C2SChoiseWan struct {
	...
	Type WAN_TYPE `protobuf:"varint,1,opt,name=type,proto3,enum=WAN_TYPE" json:"type,omitempty"` // 玩法类型
}
...
type S2CChoiseWan struct {
	...
	Ip   string `protobuf:"bytes,1,opt,name=ip,proto3" json:"ip,omitempty"`      // 玩法服务的IP或域名
	Port uint32 `protobuf:"varint,2,opt,name=port,proto3" json:"port,omitempty"` // 玩法服务的端口
}
...
func (x *S2CChoiseWan) GetIp() string {
	if x != nil {
		return x.Ip
	}
	return ""
...
func (x *S2CChoiseWan) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
var file_choise_wan_proto_rawDesc = []byte{
	...
	0x22, 0x2d, 0x0a, 0x0c, 0x43, 0x32, 0x53, 0x43, 0x68, 0x6f, 0x69, 0x73, 0x65, 0x57, 0x61, 0x6e,
	0x12, 0x1d, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x09,
	0x2e, 0x57, 0x41, 0x4e, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22,
	0x32, 0x0a, 0x0c, 0x53, 0x32, 0x43, 0x43, 0x68, 0x6f, 0x69, 0x73, 0x65, 0x57, 0x61, 0x6e, 0x12,
	...
	0x6f, 0x72, 0x74, 0x42, 0x0b, 0x5a, 0x04, 0x2e, 0x3b, 0x70, 0x62, 0xaa, 0x02, 0x02, 0x70, 0x62,
