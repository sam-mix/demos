...
func (Person_PhoneType) Descriptor() protoreflect.EnumDescriptor {
	return file_resources_proto_addressbook_proto_enumTypes[0].Descriptor()
}

func (Person_PhoneType) Type() protoreflect.EnumType {
	return &file_resources_proto_addressbook_proto_enumTypes[0]
}
...
func (Person_PhoneType) EnumDescriptor() ([]byte, []int) {
	return file_resources_proto_addressbook_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Person) Reset() {
	*x = Person{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_proto_addressbook_proto_msgTypes[0]
...
func (*Person) Descriptor() ([]byte, []int) {
	return file_resources_proto_addressbook_proto_rawDescGZIP(), []int{0}
}
...
func (x *AddressBook) Reset() {
	*x = AddressBook{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_proto_addressbook_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AddressBook) Descriptor() ([]byte, []int) {
	return file_resources_proto_addressbook_proto_rawDescGZIP(), []int{1}
}
...
func (x *Person_PhoneNumber) Reset() {
	*x = Person_PhoneNumber{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_proto_addressbook_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var File_resources_proto_addressbook_proto protoreflect.FileDescriptor

var file_resources_proto_addressbook_proto_rawDesc = []byte{
	0x0a, 0x21, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x70, 0x72,
	...
	0x65, 0x6f, 0x70, 0x6c, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x3b, 0x70, 0x62, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_resources_proto_addressbook_proto_rawDescOnce sync.Once
	file_resources_proto_addressbook_proto_rawDescData = file_resources_proto_addressbook_proto_rawDesc
)

func file_resources_proto_addressbook_proto_rawDescGZIP() []byte {
	file_resources_proto_addressbook_proto_rawDescOnce.Do(func() {
		file_resources_proto_addressbook_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_proto_addressbook_proto_rawDescData)
	})
	return file_resources_proto_addressbook_proto_rawDescData
}

var file_resources_proto_addressbook_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_resources_proto_addressbook_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_resources_proto_addressbook_proto_goTypes = []interface{}{
...
var file_resources_proto_addressbook_proto_depIdxs = []int32{
...
func init() { file_resources_proto_addressbook_proto_init() }
func file_resources_proto_addressbook_proto_init() {
	if File_resources_proto_addressbook_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_proto_addressbook_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Person); i {
			case 0:
				return &v.state
			case 1:
		...
		file_resources_proto_addressbook_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_proto_addressbook_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_proto_addressbook_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_proto_addressbook_proto_goTypes,
		DependencyIndexes: file_resources_proto_addressbook_proto_depIdxs,
		EnumInfos:         file_resources_proto_addressbook_proto_enumTypes,
		MessageInfos:      file_resources_proto_addressbook_proto_msgTypes,
	}.Build()
	File_resources_proto_addressbook_proto = out.File
	file_resources_proto_addressbook_proto_rawDesc = nil
	file_resources_proto_addressbook_proto_goTypes = nil
	file_resources_proto_addressbook_proto_depIdxs = nil
}
